...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			normal:		{ range: '-1280', href: '{{ "/css/style-normal.css" | prepend: site.baseurl }}', containers: 960, viewport: { scalable: false } },
			narrow:		{ range: '-980', href: '{{ "/css/style-narrow.css" | prepend: site.baseurl }}', containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: '{{ "/css/style-narrower.css" | prepend: site.baseurl }}', grid: { collapse: 1 } },
			mobile:		{ range: '-736', href: '{{ "/css/style-mobile.css" | prepend: site.baseurl }}', containers: '100%', grid: { gutters: 15, collapse: 2 } }
		},
		plugins: {
			layers: {
				config: {
